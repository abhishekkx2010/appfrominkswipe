...
class Users extends Admin_Controller {
	...
	{	
		$this->page_title->push(lang('users_create_user'));
        $this->data['pagetitle'] = $this->page_title->show();
        /* Breadcrumbs */
        $this->breadcrumbs->unshift(2, lang('users_create_user'), 'admin/users/create');
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
		...
		/* Validate form input */
		$this->form_validation->set_rules('first_name', 'lang:users_firstname', 'trim|required|max_length[50]');
		$this->form_validation->set_rules('last_name', 'lang:users_lastname', 'trim|required|max_length[50]');
		...
		$this->form_validation->set_rules('company', 'lang:users_company', 'trim|required|max_length[100]');
		...
		if ($this->form_validation->run() == TRUE)
		{
			...
			$groupId = array($this->input->post('groups'));
		...
		if ($this->form_validation->run() == TRUE && $this->ion_auth->register($username, $password, $email, $additional_data, $groupId))
		{
	...
	public function edit($id)
	{
        ...
        $this->data['pagetitle'] = $this->page_title->show();
        /* Breadcrumbs */
        $this->breadcrumbs->unshift(2, lang('users_edit_user'), 'admin/users/edit');
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
		...
		$this->form_validation->set_rules('email', 'lang:edit_user_validation_email_label', 'required');
	...
	{	
		$this->page_title->push(lang('menu_users_profile'));
        $this->data['pagetitle'] = $this->page_title->show();
        /* Breadcrumbs */
