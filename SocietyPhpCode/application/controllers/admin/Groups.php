...
class Groups extends Admin_Controller {
	...
	public function create()
	{
		...
		$this->page_title->push(lang('groups_create'));
        $this->data['pagetitle'] = $this->page_title->show();
        /* Breadcrumbs */
        $this->breadcrumbs->unshift(2, lang('groups_create'), 'admin/groups/create');
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
	...
	public function edit($id)
	{
		...
		$this->page_title->push(lang('groups_edit_group'));
        $this->data['pagetitle'] = $this->page_title->show();
        /* Breadcrumbs */
        $this->breadcrumbs->unshift(2, lang('groups_edit_group'), 'admin/groups/edit');
        $this->data['breadcrumb'] = $this->breadcrumbs->show();
