...
<style>
        .span_error p {
            ...
            <div class="login-logo" style="width:360px;height:100px">
                <a href="#"><img src="<?php echo base_url($avatar_dir . '/social_society_icon.png'); ?>" style="height:100%"/></a>
            </div>
            ...
            <div class="login-box-body">
                ...
                <?php echo form_open('auth/login');?>
                    <div class="form-group has-feedback">
                        ...
                        <span class="span_error"><?php echo form_error('identity'); ?></span>
                    </div>
                    <div class="form-group has-feedback">
                        <?php echo form_input($password);?>
                        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                        <span class="span_error"><?php echo form_error('password'); ?></span>
                    </div>
                    <div class="row">
                        <div class="col-xs-8">
                        ...
                        <div class="col-xs-4">
                            <?php echo form_submit('submit', lang('auth_login'), array('class' => 'btn btn-success btn-block btn-flat'));?>
                        </div>
                    </div>
                <?php echo form_close();?>
