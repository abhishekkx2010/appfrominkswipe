...
<?php endif; ?>
        ...
        <link rel="stylesheet" href="<?php echo base_url($frameworks_dir . '/adminlte/css/skins/skin-green-light.min.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url($plugins_dir . '/formvalidation/css/jquery.qtip.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url($plugins_dir . '/sweetalert/sweetalert.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url($frameworks_dir . '/adminlte/css/style.css'); ?>">
        <link rel="stylesheet" type="text/css" href="<?php echo base_url($frameworks_dir . '/adminlte/css/jquery-ui.min.css'); ?>">
...
<?php endif; ?>
        ...
        <![endif]-->
            ...
            <script src="<?php echo base_url($plugins_dir . '/formvalidation/js/jquery.qtip.js'); ?>"></script>
            <script src="<?php echo base_url($plugins_dir . '/formvalidation/js/jquery-validate.js'); ?>"></script>
            <script src="<?php echo base_url($plugins_dir . '/sweetalert/sweetalert.min.js'); ?>"></script>
            <script src="<?php echo base_url($plugins_dir . '/sweetalert/sweetalert-dev.js'); ?>"></script>
            <script src="<?php echo base_url($frameworks_dir . '/jquery/jquery-ui.min.js'); ?>"></script>
            
            <script src="<?php echo base_url($frameworks_dir . '/custom/plugins/datatables/jquery.dataTables.min.js'); ?>"></script>
        <script src="<?php echo base_url($frameworks_dir . '/custom/plugins/datatables/dataTables.bootstrap.min.js'); ?>"></script>
    </head>
