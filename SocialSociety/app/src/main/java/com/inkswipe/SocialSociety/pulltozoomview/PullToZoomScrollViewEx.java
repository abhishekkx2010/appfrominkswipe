package com.inkswipe.SocialSociety.pulltozoomview;
...
public class PullToZoomScrollViewEx extends PullToZoomBase<ScrollView> {
    private static final String TAG = com.inkswipe.SocialSociety.pulltozoomview.PullToZoomScrollViewEx.class.getSimpleName();
        ...
        public void run() {
            if (mZoomView != null) {
                ...
                if ((!mIsFinished) && (mScale > 1.0D)) {
                    ...
                    f2 = mScale - (mScale - 1.0F) * com.inkswipe.SocialSociety.pulltozoomview.PullToZoomScrollViewEx.sInterpolator.getInterpolation(f1);
