 ...
 */
public class MemberAdapter1 extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    static Context context;
    List<MembersModel> membersModelList;
    static int check;
    public MemberAdapter1(Context context, List<MembersModel> membersModelList, int check) {
